...
namespace CycloneDX.Core.Tests
{
    public class SpecficationVersionHelpersTests
    {
        ...
        [InlineData("http://cyclonedx.org/schema/bom/1.6", true)]
        [InlineData("http://cyclonedx.org/schema/bom/1.7", true)]
        [InlineData("http://cyclonedx.org/schema/bom/1.8", false)]
        ...
        [InlineData("http://cyclonedx.org/schema/bom/1.6", "1.6")]
        [InlineData("http://cyclonedx.org/schema/bom/1.7", "1.7")]
        [InlineData("http://cyclonedx.org/schema/bom/1.8", null)]
