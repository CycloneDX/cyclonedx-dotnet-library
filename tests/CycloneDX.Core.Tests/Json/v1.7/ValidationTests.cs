...
namespace CycloneDX.Core.Tests.Json.v1_7
{
    public class ValidationTests
    {
        ...
        public void ValidateJsonStringTest(string filename)
        {
            ...
            var validationResult = Validator.Validate(jsonString, SpecificationVersion.v1_7);
        ...
        public async Task ValidateJsonStreamTest(string filename)
        {
            ...
            {
                var validationResult = await Validator.ValidateAsync(jsonStream, SpecificationVersion.v1_7).ConfigureAwait(false);
        ...
        [Theory]
        [InlineData("invalid-bomformat-1.7.json")]
        [InlineData("invalid-citations-1.7.json")]
        [InlineData("invalid-component-external-version-and-range.json")]
        [InlineData("invalid-component-ref-1.7.json")]
        [InlineData("invalid-component-swid-1.7.json")]
        [InlineData("invalid-component-type-1.7.json")]
        [InlineData("invalid-component-versionRange-non-external-explicit.json")]
        [InlineData("invalid-component-versionRange-non-external-implicit.json")]
        [InlineData("invalid-dependency-1.7.json")]
        [InlineData("invalid-empty-component-1.7.json")]
        [InlineData("invalid-hash-alg-1.7.json")]
        [InlineData("invalid-hash-md5-1.7.json")]
        [InlineData("invalid-hash-sha1-1.7.json")]
        [InlineData("invalid-hash-sha256-1.7.json")]
        [InlineData("invalid-hash-sha512-1.7.json")]
        [InlineData("invalid-issue-type-1.7.json")]
        [InlineData("invalid-license-choice-1.7.json")]
        [InlineData("invalid-license-encoding-1.7.json")]
        [InlineData("invalid-license-id-1.7.json")]
        [InlineData("invalid-license-missing-id-and-name-1.7.json")]
        [InlineData("invalid-metadata-distribution-1.7.json")]
        [InlineData("invalid-metadata-license-1.7.json")]
        [InlineData("invalid-metadata-timestamp-1.7.json")]
        [InlineData("invalid-missing-component-type-1.7.json")]
        [InlineData("invalid-patch-type-1.7.json")]
        [InlineData("invalid-properties-1.7.json")]
        [InlineData("invalid-scope-1.7.json")]
        [InlineData("invalid-serialnumber-1.7.json")]
        [InlineData("invalid-service-data-1.7.json")]
        public void InvalidJsonTest(string filename)
        {
            var resourceFilename = Path.Join("Resources", "v1.7", filename);
            var jsonBom = File.ReadAllText(resourceFilename);

            var validationResult = Validator.Validate(jsonBom, SpecificationVersion.v1_7);
        ...
        public void ValidateRoundTripTest(string filename)
        {
            ...
            var validationResult = Validator.Validate(jsonBomOutput, SpecificationVersion.v1_7);
