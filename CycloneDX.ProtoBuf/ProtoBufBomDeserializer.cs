...
namespace CycloneDX.ProtoBuf
{
    ...
    public static class ProtoBufBomDeserializer
    {
        public static Models.v1_3.Bom Deserialize(Stream stream)
        {
            ...
            var bom = Serializer.Deserialize<Models.v1_3.Bom>(stream);
        ...
        public static void CleanupEmptyArrays(Models.v1_3.Bom bom)
        {
        ...
        private static void CleanupEmptyArrays(Models.v1_3.Component component)
        {
        ...
        private static void CleanupEmptyArrays(Models.v1_3.Pedigree pedigree)
        {
