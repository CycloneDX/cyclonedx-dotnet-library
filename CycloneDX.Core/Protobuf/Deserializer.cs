...
namespace CycloneDX.Protobuf
{
    ...
    public static class Deserializer
    {
        ...
        private static void CleanupEmptyArrays(CycloneDX.Models.v1_3.Component component)
        {
        ...
        private static void CleanupEmptyArrays(CycloneDX.Models.v1_3.Pedigree pedigree)
        {
